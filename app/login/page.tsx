...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-4 antialiased text-nordic-dark dark:text-gray-100 relative overflow-hidden bg-background-light dark:bg-nordic-dark py-20">
      <div className="absolute inset-0 pointer-events-none opacity-40">
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-accent/30 rounded-full blur-3xl dark:bg-mosque/10" />
