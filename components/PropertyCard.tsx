...
export default function PropertyCard({ property }: PropertyCardProps) {
    ...
    return (
        <article
            className={`bg-white  rounded-xl overflow-hidden shadow-card hover:shadow-soft transition-all duration-300 group cursor-pointer h-full flex flex-col ${property.hiddenClasses || ""
                }`}
        >
